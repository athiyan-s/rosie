...
static const _DistanceAngle_type_support_symbol_names_t _DistanceAngle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, prototype, msg, DistanceAngle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, prototype, msg, DistanceAngle)),
  }
};
...
{
  return &::prototype::msg::rosidl_typesupport_cpp::DistanceAngle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, prototype, msg, DistanceAngle)() {
  return get_message_type_support_handle<prototype::msg::DistanceAngle>();
}
